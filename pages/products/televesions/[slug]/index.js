...
const TelevesionSpaces = () => {
  ...
  const breadcrumbs = [
    ...
    <Link underline="hover" key="2" href="/products/televesions">
      <Typography
        sx={{
          fontSize: ".7rem",
          color: "#888",
            ...
            <div>
              {readmore ? (
                <ul className="flex flex-col justify-center gap-2 list-disc text-[0.6rem] leading-3 ">
                  ...
                  <li>
                    <strong> Sound Technology:</strong>{" "}
                  ...
                  <li>
                    <strong>Tv features:</strong> <span>{data.Features}</span>
                  </li>
                  <li>
                    <strong>Energy efficiency information:</strong>
                    <span>{data.Energy}</span>
                  </li>

                  <li>
                    <strong>In the box:</strong> <span>{data.Box}</span>
                  </li>
                </ul>
              ) : (
                <ul className="flex flex-col justify-center gap-2 list-disc text-[0.6rem] leading-3 ">
...
export default TelevesionSpaces;
